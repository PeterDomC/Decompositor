...
public class GRBVarSet{
    ...
    HashMap<Letter,GRBVar> MVars;

    public GRBVarSet(int s, int k){
        ...
        MVars = new HashMap<Letter,GRBVar>();
    }
    ...
    public void addM(Letter A, GRBVar m){
        MVars.put(A,m);
    }
